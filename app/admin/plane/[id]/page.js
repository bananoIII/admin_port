...
import { PlaneUpdate, DeleteAccount, GeneralSetting, EmailSetting, Preferences } from 'sub-components'
                    ...
                    <Col lg={12} md={12} xs={12}>
                        ...
                        <div>
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <h3 className="mb-0  text-white">Actualizar avion </h3>
