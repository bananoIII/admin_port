...
import { FlightUpdate, DeleteAccount, GeneralSetting, EmailSetting, Preferences } from 'sub-components'
    ...
    return (
        <Fragment>
            ...
            <Container fluid className="mt-n22 px-6">
                    ...
                    <Col lg={12} md={12} xs={12}>
                        ...
                        <div>
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <h3 className="mb-0  text-white">Configuracion del vuelo </h3>
                ...
                <FlightUpdate flightId={params.id} />
            </Container>
        </Fragment>
    )
}
